...
{	
	...
	if(form1.lastName.value=='')
	{
		...
		document.lastName.mailId.focus();
		return false;
	} 
...
function validateEditQuiz(editQid,defaultLang)
{
	...
	var qusHint='EditHintText'+defaultLang;
	if(editQid!="")
	{
		document.getElementById("questnId").value=editQid;
	}
...
function validateEditQuizAllLanguages(editQid,defaultLang)
{
	...
	for(var k=0;k<arrayOfLanguages.length;k++)
	{
		...
		qusHint = 'EditHintText'+defaultLang;
		if(editQid!="")
		{
			document.getElementById("questnId").value=editQid;
		}
		...
		if((document.getElementById(qusHint).value!=" ") || (document.getElementById(qusHint).value!=""))
		{
			// alert("Hint: "+document.getElementById("hintTexthi-IN").value);
			document.getElementById(qusHint).value = btoa(encodeURIComponent(document.getElementById(qusHint).value));
		}
	}
	return;
...
{	
	// Reverse the encryption variable
    ...
    {
		ReverseTheEncryption.push(document.getElementById(fillquestionId));
        document.getElementById(fillquestionId).value = btoa(encodeURIComponent(document.getElementById(fillquestionId).value));
    }
	...
	{		
		...
		for (var i = 0; i <= incVal; i++)
		{
			...
			if(document.getElementById("objective"+j+defaultLang))
			{
				...
				{
					ReverseTheEncryption.push(document.getElementById("objective"+j+defaultLang));
					document.getElementById("objective"+j+defaultLang).value = btoa(encodeURIComponent(document.getElementById("objective"+j+defaultLang).value));
				}	
			}
		}
	...
	// hintFill
	var qusHint = "hintFill"+defaultLang;
	if((document.getElementById(qusHint).value!=" ") || (document.getElementById(qusHint).value!=""))
	{
		document.getElementById(qusHint).value = btoa(encodeURIComponent(document.getElementById(qusHint).value));
	}
	validateFillInTheBlanks2(formname,defaultLang)
	return true;
}
function validateFillInTheBlanks2(formname,defaultLang)
{	
